...
21 compiler and test runtime through its toolchain configuration. See
https://github.com/rainguy/jgnash/blob/master/docs/building.md[Java 21 build requirements]
for discovery and troubleshooting.
