...
== Release 3.7.2
* 08/08/2026 Fixed an autocomplete initialization race that could prevent the JavaFX interface from starting.
* 08/08/2026 Fixed HSQLDB file handles remaining open after a failed password attempt.
* 08/08/2026 Added reproducible cross-platform verification for Linux, Windows, macOS Intel, and Apple Silicon.

== Release 3.7.1
* 08/08/2026 Fixed the bootloader downloading JavaFX 15 instead of the JavaFX 21 runtime used by the application.

== Release 3.7.0
* 08/08/2026 Updated the build and runtime baseline to Java 21.
* 08/08/2026 Centralized build conventions and dependency versions.
* 08/08/2026 Updated JavaFX, test, utility, serialization, document, and networking dependencies on compatible release lines.
* 08/08/2026 Fixed a race while waiting for database lock files to be removed.
